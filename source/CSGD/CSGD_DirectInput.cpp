...
std::vector<CSGD_DIJoystick*> CSGD_DirectInput::GetNumJoysticks(void) { return m_vpJoysticks; }
...
bool CSGD_DirectInput::Initialize(HWND hWnd, HINSTANCE hInstance, unsigned int unInitDevices, unsigned int unExclusiveDevices)
{
	...
	if (unInitDevices & DI_JOYSTICKS)
		...
		{                            //true = windowed
			CGame::GetInstance()->Fullscreen(false);
			CGame::GetInstance()->LockScreen(true);
		}
...
///////////////////////////////////////////////////////////////////	
void CSGD_DirectInput::ClearInput(void)
{
	if (m_pKeyboard)
	{
...
///////////////////////////////////////////////////////////////////
const TCHAR* CSGD_DirectInput::JoystickGetName(int nJoyNum)	const { return (nJoyNum >= 0 && nJoyNum < (int)m_vpJoysticks.size()) ? m_vpJoysticks[nJoyNum]->GetName() : _T("Doesn't exist"); }
...
CSGD_DIMouse::CSGD_DIMouse(LPDIRECTINPUT8 pDI, HWND hWnd, bool bIsExclusive)
{
	...
	if (FAILED( m_lpDevice->Acquire() ))
	{
		OutputDebugString( _T("SGD DIRECTINPUT - Failed to acquire Mouse\n") );
