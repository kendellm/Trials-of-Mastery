...
class CPerform_Sweeping_Wind_MSG : public CMessage
{

public:
	CPerform_Sweeping_Wind_MSG(float x, float y, int level=1, int owner=0, bool flip=true);
	~CPerform_Sweeping_Wind_MSG(void);
