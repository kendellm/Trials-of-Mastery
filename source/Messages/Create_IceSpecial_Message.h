...
class CCreate_IceSpecial_Message : public CMessage
{
private:
	int m_nOwner;
	float m_nPosX;
...
public:
	CCreate_IceSpecial_Message(int owner = 0, bool flipped = true, float x = 0, float y = 0);
	~CCreate_IceSpecial_Message(void);
