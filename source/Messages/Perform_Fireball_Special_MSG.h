...
class CPerform_Fireball_Special_MSG : public CMessage
{
public:
	CPerform_Fireball_Special_MSG(float x, float y, int level=1, int owner=0, bool flip=true);
	~CPerform_Fireball_Special_MSG(void);
